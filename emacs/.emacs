(fset 'split
   (lambda (&optional arg) "Keyboard macro." (interactive "p") (kmacro-exec-ring-item (quote ("3o22oo0" 0 "%d")) arg)))
...
names to which it refers are bound."
  (quote
   `(;; Standard font lock faces
     ...
     (isearch ((,class (:foreground ,orange :background ,background :inverse-video t))))
     ...
     (mode-line-buffer-id ((,class (:foreground ,yellow :background nil))))
